      ...
      <div className={`container ${deviceType}`} style={{color: 'white'}}>
        <div className="content flex flex-col justify-evenly">
          ...
          <div className="form flex">
            <Link href={'mailto:pochta@gmail.com'} 
              style={{textDecoration: 'underline', textDecorationSkipInk: "none", height: 'fit-content'}} 
              className="big-font">
                pochta@gmail.com
            </Link>
            <form className="flex flex-col" onSubmit={formik.handleSubmit}>
              <input name="name" onChange={formik.handleChange} onBlur={formik.handleBlur} placeholder="Ваше имя" className="big-font"/>
              <input name="email" onChange={formik.handleChange} onBlur={formik.handleBlur} placeholder="Ваш email" className="big-font"/>
              <RequestButton deviceType={deviceType} type='submit' className={`h3-font`} disabled={isLoading || isSuccess}>{isLoading ? 'Загрузка' : isSuccess ? 'Успешно' : 'Связаться'}</RequestButton> 
            </form>
          </div>
            ...
            <div className="links-container flex flex-col">
              ...
              <div className="links-col flex flex-col">
                <div className="flex flex-row" style={{gap: '45px'}}>
                  <Link href={'#'} style={{width: 'calc((100% - 90px)/3)'}}><p>Instagram</p></Link>
