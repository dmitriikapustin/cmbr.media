...
export default function AboutBlock({ deviceType }) {
	return (
		<section className={`about-block block h-fit ${deviceType}`} id='about'>
				...
				<div className='content flex'>
					<div className='card flex flex-col'>
						...
						<Image
							...
							width={1000}
							height={1000}
							src='/svg/about-text.svg'
							style={{ width: '65%', height: 'auto' }}
						/>
						<p>
							Мы коммьюнити креаторов, с опытом работы более 10 лет, способные воплотить в
							жизнь любую задачу, от репортажки до самых безумных задумок в мире музыки,
							творчества и рекламы.
						</p>
					</div>
					<div className='card flex flex-col'>
